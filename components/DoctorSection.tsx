    ...
    <section className="py-20 md:py-32 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-surface-page border border-border-subtle text-brand-navy text-[10px] font-black uppercase tracking-widest mb-6">
              ...
              <p className="text-lg text-fg-secondary leading-relaxed mb-6 font-medium">
                Considered one of the world's leading experts in anti-aging and
                regenerative medicine, Dr. Shallenberger has dedicated four
                decades to unlocking the secrets of longevity.
              </p>
            </div>

            {/* Redesigned Clinical Row */}
            <div className="flex flex-col sm:flex-row gap-6">
              <div className="flex-1 flex gap-4 items-start p-4 bg-surface-page border-l-4 border-brand-blue rounded-r-xl">
                <Award className="text-brand-blue shrink-0" size={24} />
                <div>
                  <h3 className="font-bold text-brand-navy text-sm uppercase tracking-wide">
                    Board Certified
                  </h3>
                  <p className="text-sm text-fg-secondary mt-1 leading-snug">
                    Pioneer in orthomolecular medicine and oxidative therapies.
                  </p>
                </div>
              </div>
              <div className="flex-1 flex gap-4 items-start p-4 bg-surface-page border-l-4 border-brand-blue rounded-r-xl">
                ...
                <div>
                  ...
                  <p className="text-sm text-fg-secondary mt-1 leading-snug">
                    Multiple breakthroughs in skeletal muscle metabolism.
                  </p>
                </div>
              </div>
            </div>

            <div className="bg-fg-brand p-8 rounded-[2rem] text-white relative group">
              <Quote
              ...
              <p className="text-lg md:text-xl italic font-serif leading-relaxed relative z-10 mb-6 font-light">
                "The biggest mistake seniors make is thinking they just need
                more protein. What they actually need is the right clinical
                ratio of amino acids to bypass the metabolic waste bottleneck."
              </p>
