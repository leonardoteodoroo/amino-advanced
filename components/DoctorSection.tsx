                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-6">
                            <div className="flex-1 flex gap-4 items-start p-4 bg-surface-page border-l-4 border-brand-blue rounded-r-xl">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-fg-secondary mt-1 leading-snug">Pioneer in orthomolecular medicine and oxidative therapies.</p>
                                </div>
                            </div>
                            <div className="flex-1 flex gap-4 items-start p-4 bg-surface-page border-l-4 border-brand-blue rounded-r-xl">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-fg-secondary mt-1 leading-snug">Multiple breakthroughs in skeletal muscle metabolism.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-fg-brand p-8 rounded-[2rem] text-white relative group">
                            ...
                            <div className="flex items-center gap-4 relative z-10">
                                ...
                                <span className="font-bold uppercase tracking-[0.2em] text-[10px] text-white">Dr. Frank Shallenberger</span>
                            </div>
                        </div>
                    </motion.div>
                </div>
