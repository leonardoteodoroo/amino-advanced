        ...
        <ClinicalCard className="p-6 md:p-12 relative overflow-hidden bg-white">
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
            <div className="flex-1 min-w-0 space-y-8 md:space-y-10">
              <div className="relative">
                ...
                <div className="pl-6">
                  <p className="text-fg-brand text-base md:text-lg leading-relaxed mb-6 font-serif italic border-l-4 border-border-subtle pl-4 py-2 bg-surface-page rounded-r-lg">
                    "It’s a quiet frustration. You walk every morning, you try
                    to eat right, but your legs feel a bit{" "}
                    <span className="text-fg-primary font-bold not-italic">
                      "heavier"
                    </span>{" "}
                    each year."
                  </p>
                  <div className="p-4 rounded-xl bg-warning-bg border border-feedback-warning/20 flex gap-4 items-start">
                    ...
                    <div>
                      <p className="text-fg-brand text-xs font-bold uppercase tracking-widest mb-1">
                        The Ugly Truth
                      </p>
                      <p className="text-text-primary font-medium text-base md:text-lg leading-snug">
                        Nobody in the supplement industry wants to admit this:{" "}
                        <span className="font-bold text-action-strong">
                          After 50, your body treats most protein like garbage.
                        </span>
                      </p>
                    </div>
                  </div>
              ...
              <div>
                <h2 className="text-2xl md:text-4xl font-serif font-bold mb-4 text-text-brand break-words">
                  The "Anabolic Lock"
                </h2>
                <p className="text-text-secondary text-base md:text-lg mb-4">
                  Research shows that after age 50, muscles develop a condition
                  called{" "}
                  <strong className="text-text-primary">
                    Anabolic Resistance
                  </strong>
                  . It’s a biological "lock" that prevents normal protein from
                  triggering muscle repair.
                </p>
                <StaggerText
                ...
                <div className="bg-surface-highlight border-l-4 border-action-primary p-5 rounded-r-xl mb-6 shadow-sm">
                  <h3 className="text-text-brand font-bold text-lg mb-2">
                    The Leucine Threshold Key
                  </h3>
                  <p className="text-text-secondary text-sm md:text-base leading-relaxed">
                    To break Anabolic Resistance, your blood needs a surgical
                    strike of{" "}
                    <span className="font-bold text-text-brand">
                      3.0g of pure Leucine
                    </span>
                    . Traditional protein requires you to eat massive calories
                    just to reach this threshold—but Advanced Amino provides it
                    instantly.
                  </p>
                </div>
                <p className="text-text-secondary leading-relaxed text-base md:text-lg">
                  Advanced Amino skip the digestion 'bottleneck' entirely. While
                  Whey leaves a massive surplus of metabolic waste (ammonia),
                  this formula provides{" "}
                  <span className="text-text-brand font-bold">
                    99% Net Nitrogen Utilization (NNU)
                  </span>
                  .
                </p>
                <div className="mt-4 flex items-center gap-2 text-green-700 font-bold text-sm bg-green-50 p-3 rounded-lg border border-green-200 shadow-sm">
                  <ShieldCheck size={18} /> Nearly zero metabolic waste or
                  calories.
                </div>
              </div>
            </div>
