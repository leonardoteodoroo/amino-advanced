...
export const LegalPage: React.FC<LegalPageProps> = ({ title, content, onBack }) => {
    return (
        <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="min-h-screen bg-surface-page pt-24 pb-20 px-4"
        >
            <div className="max-w-3xl mx-auto bg-white rounded-3xl border border-border-subtle shadow-xl p-8 md:p-12">
                <button
                    onClick={onBack}
