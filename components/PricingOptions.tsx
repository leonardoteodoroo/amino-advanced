...
const PricingCard: React.FC<PricingCardProps> = ({
  ...
  return (
    ...
    >
      {isBestValue && (
        <div className="absolute -top-8 left-1/2 -translate-x-1/2 w-[92%] md:w-[95%] bg-gradient-to-br from-red-600 via-red-700 to-orange-600 text-white shadow-2xl z-20 flex flex-col items-center justify-center py-2 px-1 rounded-xl border-2 border-white/30 backdrop-blur-sm">
          <div className="flex items-center gap-1.5 mb-1">
            ...
            <span className="text-[10px] md:text-[11px] font-black uppercase tracking-wider text-center">
      ...
      <GlassCard
        className={`h-full flex flex-col p-6 relative overflow-hidden transition-all duration-300 ${
          isBestValue
      ...
      >
        ...
        <div className="space-y-3 mb-8 flex-grow relative z-10">
          {features.map((feature, idx) => (
            <div key={idx} className="flex items-start gap-3">
              ...
              <span className="text-sm text-text-secondary leading-snug font-medium">
                {feature}
              </span>
            </div>
          ))}
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.98 }}
          className={`w-full py-4 rounded-xl font-bold text-sm tracking-wide uppercase flex items-center justify-center gap-2 transition-all shadow-md hover:shadow-lg ${
            isBestValue
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-text-secondary max-w-2xl mx-auto">
            Select the package that fits your goals. Most new customers start
            with the 3-month supply to fully experience the muscle-waking
            effects.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-20 md:gap-8 items-stretch pt-16">
          ...
          <PricingCard
            ...
            perBottle="$39.95"
            price="$39.95"
            commissionValue={4.0} // Ultra-Conservador: ~1/3 do valor esperado ($12 -> $4)
            ...
            link="https://www.checkout-ds24.com/product/472629?aff=leonardoteodorol"
            delay={0.1}
            imgWidth={300}
            imgHeight={327}
          />
          ...
          <PricingCard
            ...
            price="$107.85"
            savings="Save $12.00"
            commissionValue={12.0} // Ultra-Conservador: ~1/3 do valor esperado ($36 -> $12)
            isPopular
            ...
            link="https://www.checkout-ds24.com/product/472942?aff=leonardoteodorol"
            delay={0.2}
            imgWidth={300}
            imgHeight={300}
          />
          ...
          <PricingCard
            ...
            price="$199.50"
            savings="Save $40.20"
            commissionValue={20.0} // Ultra-Conservador: ~1/3 do valor esperado ($65 -> $20)
            isBestValue
            ...
            link="https://www.checkout-ds24.com/product/472943?aff=leonardoteodorol"
            delay={0.3}
            imgWidth={300}
            imgHeight={300}
          />
        ...
        <div className="mt-12 max-w-2xl mx-auto bg-blue-50 border border-blue-100 rounded-2xl p-4 flex items-start gap-4 mb-12">
          ...
          <div>
            <h4 className="text-brand-navy font-bold text-sm uppercase tracking-wide mb-1">
              Doctor's Guarantee
            </h4>
            <p className="text-text-secondary text-sm leading-relaxed">
              "If you don't feel a distinct difference in your energy and muscle
              firmness within 90 days, I don't want your money. Return the empty
              bottles for a full refund." — Dr. Frank Shallenberger
            </p>
          </div>
          <img
