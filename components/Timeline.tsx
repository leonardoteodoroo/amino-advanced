...
const timelineData: TimelineItem[] = [
  {
    ...
    description:
      "After 50, muscles develop 'Anabolic Resistance'—a biological lock that shuts out ordinary protein. Advanced Amino is the specific 'key' that forces the muscle to accept nutrition again.",
  ...
  },
  {
    ...
    description:
      "While Whey protein leaves 83% metabolic waste, this precise ratio provides 99% Net Nitrogen Utilization (NNU). Practically every gram goes straight to tissue repair, not 'garbage'.",
  ...
  },
  {
    ...
    description:
      "Unlike high-protein diets that stress your filtration system with ammonia waste, Advanced Amino creates almost zero metabolic byproduct. It's the safest way to rebuild for seniors.",
  ...
  },
  {
    ...
    description:
      "Ordinary protein takes hours to break down. These amino acids reach your bloodstream in minutes, providing an immediate 'Anabolic Strike' to starving muscle fibers.",
  ...
  return (
    <div ref={containerRef} className="relative py-20 px-4 max-w-5xl mx-auto">
      <div className="text-center mb-16 px-2 relative z-10">
        <BlurText
          text="The Math of Strength"
          className="text-3xl md:text-5xl font-serif font-bold text-brand-navy mt-2 mb-6"
        />
      </div>
  ...
  return (
    ...
    >
      ...
      */}
      ...
      {/* Content Card */}
      <div
        className={`ml-16 md:ml-0 md:w-1/2 w-[calc(100%-4rem)] min-w-0 ${isEven ? "md:pr-16" : "md:pl-16"}`}
      >
        <GlassCard
        ...
        >
          <div className="flex items-center gap-4 mb-3">
            <h3 className="text-xl font-bold text-brand-navy break-words">
              {item.title}
            </h3>
          </div>
