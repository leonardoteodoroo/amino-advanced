      ...
      >
        ...
        >
          {tickerReviews.map((review, i) => (
            <div
              key={i}
              className="w-[300px] md:w-[320px] flex-shrink-0 p-5 rounded-xl bg-white border border-border-subtle shadow-sm hover:shadow-md transition-shadow relative group select-none"
            >
              ...
              <p className="text-text-secondary text-sm leading-relaxed mb-4 min-h-[60px] pointer-events-none">
                "{review.text}"
              </p>
              ...
              <div className="flex items-center gap-3 pt-3 border-t border-border-subtle pointer-events-none">
                ...
                <div>
                  ...
                  <p className="text-xs text-text-muted">
                    {review.age} years old • Verified Buyer
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex items-center gap-2 opacity-40 md:hidden pointer-events-none">
          <span className="text-[10px] uppercase tracking-tighter font-bold text-text-primary">
            Swipe to browse
          </span>
