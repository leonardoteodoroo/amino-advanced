  ...
  const studies = [
    {
      ...
      result:
        "Aging skeletal muscle requires a critical 'Leucine Threshold' to activate the mTORC1 pathway, the master switch for muscle tissue repair.",
    ...
    },
    {
      ...
      result:
        "Essential amino acid bioavailability is the primary determinant in reversing anabolic resistance in the aging phenotype.",
    ...
    },
    {
      ...
      result:
        "Emerging evidence links gut microbiome health directly to sarcopenia, showing that clinical-grade aminos reduce systemic inflammation.",
    ...
    },
    {
      ...
      result:
        "Clinical studies demonstrate that formulas reaching 99% NNU produce nearly zero nitrogen waste (Ammonia), sparing renal function.",
    ...
    <section className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <p className="text-sm font-bold text-brand-blue uppercase tracking-widest mb-3">
        ...
        <div className="mt-12 text-center">
          <p className="text-xs text-text-muted max-w-2xl mx-auto">
            *This summary represents synthesis from clinical data sources
            available in our scientific research repository. Citations refer to
            studies documenting the mechanism of action of EAAs and mTORC1
            pathways.
          </p>
        </div>
      </div>
