...
const reviews: Review[] = [
  {
    ...
    detail:
      "It feels like my muscles are finally waking up. My workouts improved and recovery became much faster after just two months.",
    rating: 5,
  ...
  },
  {
    ...
    detail:
      "I feel more stable on long walks. After three months, my joints felt less sore and my stability increased significantly.",
    rating: 5,
  ...
  },
  {
    ...
    detail:
      "My doctor noticed the difference. The improvement in muscle tone and general vitality really surprised him during my last check-up.",
    rating: 5,
  ...
  },
  {
    ...
    detail:
      "I used to sit and watch my grandkids play because I couldn't get back up. Now I'm on the floor building forts and chasing them around the yard.",
    rating: 5,
  ...
  },
  {
    ...
    detail:
      "I moved my bedroom downstairs because the steps were torture on my thighs. Two months in, I'm back up in the master bedroom and climbing without gripping the rail.",
    rating: 5,
  ...
  },
  {
    ...
    detail:
      "My garden was neglected because 20 minutes of weeding left me exhausted for days. Last weekend I spent 4 hours expanding my flower beds with zero crash.",
    rating: 5,
  ...
  },
  {
    ...
    detail:
      "My swing speed was dropping every year. My buddies asked what I changed because I'm adding 20 yards to my drive and finishing 18 holes feeling fresh.",
    rating: 5,
  ...
  },
  {
    ...
    detail:
      "I almost cancelled my dream trip to Rome because I feared the walking tours. I ended up walking 12,000 steps a day and kept up with the group perfectly.",
    rating: 5,
  ...
  },
  {
    ...
    detail:
      "It sounds small, but having to make three trips for light groceries was humiliating. Now I carry the heavy bags in one go like I did ten years ago.",
    rating: 5,
  ...
  },
  {
    ...
    detail:
      "I bought it for my legs, but the brain fog lifted too. I have the sustained mental and physical energy to finish my work day without a nap.",
    rating: 5,
...
const TestimonialCard: React.FC<{ review: Review }> = ({ review }) => {
  return (
    <div className="w-full h-full bg-white flex flex-col p-5 md:p-6 font-sans relative overflow-hidden select-none pointer-events-none">
      ...
      <Quote
        className="absolute top-4 right-4 text-indigo-100/50 rotate-180"
        size={80}
        strokeWidth={1}
      />
      ...
      <div className="flex items-center gap-3 mb-4 relative z-10">
        ...
        <div>
          <div className="flex items-baseline gap-2">
            <h4 className="font-bold text-fg-brand leading-none text-base truncate max-w-[120px]">
              {review.name}
            </h4>
            <span className="text-fg-muted text-sm font-medium whitespace-nowrap">
              {review.age}y
            </span>
          </div>
          <div className="flex items-center gap-1 mt-0.5">
            <CheckCircle2 size={12} className="text-green-500 fill-white" />
            <span className="text-[10px] text-fg-muted font-bold uppercase tracking-wide">
              Verified Buyer
            </span>
          </div>
        </div>
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-left space-y-6 relative z-20">
          ...
          <p className="text-text-secondary text-lg leading-relaxed max-w-md">
            These aren't just reviews. These are people reclaiming their
            independence, strength, and confidence after years of feeling
            "slowed down".
          </p>
          <div className="flex items-center gap-4 pt-4">
            <div className="flex -space-x-3">
              {[
                "/images/reviews/jacqui.webp",
                "/images/reviews/carolyn.webp",
                "/images/reviews/dr-simmons.webp",
              ].map((src, i) => (
                <img
                  key={i}
                  src={src}
                  className="w-10 h-10 rounded-full border-2 border-white object-cover bg-surface-section"
                  alt="Verified User"
                  width="40"
                  height="40"
                  loading="lazy"
            ...
            <div className="text-sm text-text-muted">
              <span className="text-brand-navy font-bold">12,400+</span> Active
              Users
            </div>
          </div>
          ...
          <div className="hidden md:flex gap-4 mt-8">
            ...
            >
              <ChevronLeft
                className="text-text-secondary group-hover:text-brand-blue"
                size={24}
              />
            </button>
            <button
        ...
        <div className="relative flex flex-col items-center justify-center">
          ...
          <div className="flex md:hidden flex-col items-center mt-6 gap-4 relative z-50 pointer-events-none">
            ...
            <div className="flex items-center gap-2 opacity-80">
              <span className="text-brand-blue font-serif italic text-xs tracking-wide">
                Swipe to read
              </span>
              <MoveRight
                className="text-brand-blue animate-pulse motion-reduce:animate-none"
                size={20}
              />
            </div>
          </div>
...
const CarouselCard: React.FC<CarouselCardProps> = ({
  ...
  const rotateY = useTransform(
    position,
    [-gap, 0, gap],
    shouldReduceMotion ? [0, 0, 0] : [25, 0, -25],
  );
